...
/***/ "./public/scripts/components/auth/menu.js":
/*!************************************************!*\
  !*** ./public/scripts/components/auth/menu.js ***!
  \************************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../main */ \"./public/scripts/main.js\");\n/* harmony import */ var _main__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_main__WEBPACK_IMPORTED_MODULE_1__);\n\n\n/***\r\n *\r\n * Front-end Menu Component\r\n *\r\n ***/\n\n$(function () {\n  $('.login').on('click', function () {\n    $('#login-register').hide();\n    $('#login-form').show();\n  });\n  $('.login-form-register').on('click', function () {\n    $('#login-form').hide();\n    $('#register-form').show();\n  });\n  $('.register').on('click', function () {\n    $('#login-register').hide();\n    $('#register-form').show();\n  });\n  $('.register-form-login').on('click', function () {\n    $('#register-form').hide();\n    $('#login-form').show();\n  });\n  $('#register-form').on('submit', function (e) {\n    e.preventDefault();\n    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/auth/register', $(this).serialize()).then(function (response) {\n      alert(response.data.message);\n    });\n  });\n  $('#login-form').on('submit', function (e) {\n    e.preventDefault();\n    var data = $(this).serialize() + '&socket=' + socket.id;\n    axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/auth/login', data).then(function (res) {\n      alert(res.data.message);\n\n      if (res.data.status === 200) {\n        Object(_main__WEBPACK_IMPORTED_MODULE_1__[\"gameInitialize\"])(res.data.players, res.data.mapData);\n      }\n    });\n  });\n});\n\n//# sourceURL=webpack:///./public/scripts/components/auth/menu.js?");
...
eval("function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n/***\r\n *\r\n * Front-end Asset Loader Component\r\n *\r\n ***/\nvar MapRender = __webpack_require__(/*! ./map/render */ \"./public/scripts/components/game/assets/map/render.js\");\n\nvar AssetLoader = /*#__PURE__*/function () {\n  function AssetLoader() {\n    _classCallCheck(this, AssetLoader);\n\n    this.assetsLoaded = 0; // Map Loading\n\n    this.mapRender = new MapRender(); // Libraries\n\n    this.images = [];\n    this.sounds = [];\n  }\n  /*\r\n   * Main Asset Loader Functions\r\n   */\n  // Checks an asset to see if it has been loaded.\n\n\n  _createClass(AssetLoader, [{\n    key: \"assetLoaded\",\n    value: function assetLoaded(array, name) {\n      // Ignore already loaded assets\n      if (this[array][name].status !== 'loading') return;\n      this[array][name].status = 'loaded';\n      this.assetsLoaded++;\n    } // Loads all the assets.\n\n  }, {\n    key: \"loadAssets\",\n    value: function loadAssets() {\n      this.loadImages();\n      this.loadSounds();\n    }\n    /*\r\n     * Image Related Functions.\r\n     */\n\n  }, {\n    key: \"addImage\",\n    value: function addImage(name, file) {\n      this.images[name] = file;\n    }\n  }, {\n    key: \"loadImages\",\n    value: function loadImages() {\n      var _this = this;\n\n      var _loop = function _loop() {\n        if (!_this.images[image]) return \"continue\";\n        var $this = _this;\n        var src = _this.images[image];\n        _this.images[image] = new Image();\n        _this.images[image].status = 'loading';\n        _this.images[image].name = image;\n        _this.images[image].src = src;\n\n        _this.images[image].onload = function () {\n          $this.assetLoaded.call($this, \"images\", image);\n        };\n      };\n\n      for (image in this.images) {\n        var _ret = _loop();\n\n        if (_ret === \"continue\") continue;\n      }\n    }\n    /*\r\n     * Map Related Functions.\r\n     */\n\n  }, {\n    key: \"loadMap\",\n    value: function loadMap(mapData) {\n      this.loadMapSounds(mapData.sounds);\n      this.mapRender.loadMap(mapData);\n    }\n  }, {\n    key: \"loadMapSounds\",\n    value: function loadMapSounds(mapSounds) {\n      for (var s = 0; s <= mapSounds.length; s++) {\n        var _sound = mapSounds[s];\n        if (!_sound) continue;\n        this.addSound(_sound.name, _sound.location);\n      }\n    }\n    /*\r\n     * Sound Related Functions\r\n     */\n\n  }, {\n    key: \"addSound\",\n    value: function addSound(name, file) {\n      this.sounds[name] = file;\n    }\n  }, {\n    key: \"checkAudioState\",\n    value: function checkAudioState(sound) {\n      if (this.sounds[sound].status === 'loading' && this.sounds[sound].readyState === 4) {\n        this.assetLoaded('sounds', sound);\n      }\n    }\n  }, {\n    key: \"loadSounds\",\n    value: function loadSounds() {\n      var _this2 = this;\n\n      var _loop2 = function _loop2() {\n        if (!_this2.sounds[sound]) return \"continue\";\n        var $this = _this2;\n        var src = _this2.sounds[sound];\n        _this2.sounds[sound] = new Audio();\n        _this2.sounds[sound].status = 'loading';\n        _this2.sounds[sound].name = sound;\n\n        _this2.sounds[sound].addEventListener('canplay', function () {\n          $this.checkAudioState(sound);\n        });\n\n        _this2.sounds[sound].src = src;\n        _this2.sounds[sound].preload = 'auto';\n\n        _this2.sounds[sound].load();\n      };\n\n      for (sound in this.sounds) {\n        var _ret2 = _loop2();\n\n        if (_ret2 === \"continue\") continue;\n      }\n    }\n  }]);\n\n  return AssetLoader;\n}();\n\nmodule.exports = AssetLoader;\n\n//# sourceURL=webpack:///./public/scripts/components/game/assets/assetLoader.js?");

/***/ }),

/***/ "./public/scripts/components/game/assets/map/render.js":
/*!*************************************************************!*\
  !*** ./public/scripts/components/game/assets/map/render.js ***!
  \*************************************************************/
/*! no static exports found */
...
/***/ "./public/scripts/components/game/render/animation/animation.js":
/*!**********************************************************************!*\
  !*** ./public/scripts/components/game/render/animation/animation.js ***!
  \**********************************************************************/
/*! no static exports found */
...
eval("function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n/***\r\n *\r\n * Front-end Animation Component\r\n *\r\n ***/\nvar Animation = function Animation() {\n  _classCallCheck(this, Animation);\n};\n\nmodule.exports = Animation;\n\n//# sourceURL=webpack:///./public/scripts/components/game/render/animation/animation.js?");

/***/ }),

/***/ "./public/scripts/components/game/render/canvas.js":
/*!*********************************************************!*\
  !*** ./public/scripts/components/game/render/canvas.js ***!
  \*********************************************************/
/*! no static exports found */
...
eval("function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n/***\r\n *\r\n * Front-end Canvas Component\r\n *\r\n ***/\n// Setup the relevant requirements for the file.\nvar PlayerRender = __webpack_require__(/*! ./drawing/entities/playerRender */ \"./public/scripts/components/game/render/drawing/entities/playerRender.js\");\n\nvar Animation = __webpack_require__(/*! ./animation/animation */ \"./public/scripts/components/game/render/animation/animation.js\");\n\nvar Canvas = /*#__PURE__*/function () {\n  function Canvas() {\n    _classCallCheck(this, Canvas);\n\n    this.playerRender = new PlayerRender();\n    this.animation = new Animation();\n  }\n\n  _createClass(Canvas, [{\n    key: \"drawPlayerStates\",\n    value: function drawPlayerStates(players) {\n      playerContext.clearRect(0, 0, mapCanvas.width, mapCanvas.height); // Loop the player object that we're passed.\n\n      for (var id in players) {\n        var player = players[id];\n        this.playerRender.drawSprite(player); // SOUND RELATED\n\n        var playerX = Math.round(player.x / 16),\n            playerY = Math.round(player.y / 16),\n            tile = player.globalMapData.layers[0].data[playerY * player.globalMapData.width + playerX];\n\n        if (player.movement.up || player.movement.down || player.movement.right || player.movement.left) {\n          if (game.assetLoader.sounds[tile]) {\n            game.assetLoader.sounds[tile].play();\n            game.lastPlayedTileSound = tile;\n          }\n        } else {\n          if (game.assetLoader.sounds[game.lastPlayedTileSound]) {\n            game.assetLoader.sounds[game.lastPlayedTileSound].pause();\n          }\n        }\n      }\n    }\n  }]);\n\n  return Canvas;\n}();\n\nmodule.exports = Canvas;\n\n//# sourceURL=webpack:///./public/scripts/components/game/render/canvas.js?");

/***/ }),

/***/ "./public/scripts/components/game/render/drawing/entities/playerRender.js":
/*!********************************************************************************!*\
  !*** ./public/scripts/components/game/render/drawing/entities/playerRender.js ***!
  \********************************************************************************/
/*! no static exports found */
